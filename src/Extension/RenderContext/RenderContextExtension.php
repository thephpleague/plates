...
final class RenderContextExtension implements Plates\Extension
{
    public function register(Plates\Engine $plates)
    {
        ...
        $c->add(
            'renderContext.func.funcs', function ($c) {
        ...
        $plates->addMethods(
            ...
            'registerFunction' => function (Plates\Engine $e, $name, callable $func, callable $assert_args = null, $simple = true) {
                ...
                $c->wrap(
                    'renderContext.func.funcs', function ($funcs, $c) use ($name, $func, $assert_args) {
            ...
            'addFuncs' => function (Plates\Engine $e, callable $add_funcs, $simple = false) {
                $e->getContainer()->wrap(
                    'renderContext.func.funcs', function ($funcs, $c) use ($add_funcs, $simple) {
                        $new_funcs = $simple
